...
# print('Optimal gamma: ')
# print(gamma)
# print('Optimal min error: ')
# print((FP / N)*q1.priors[0] + (FN / P)*q1.priors[1])
# plt.title('ERM ROC Curve')
# plt.legend(handles=[Line2D([0], [0], marker='o', color='w', label='Optimal Gamma', markerfacecolor='g', markersize=10)])
...
q1.logistic_regression(D20_train, L20_train, D10k_val, L10k_val, title='20 Training Samples')
q1.logistic_regression(D200_train, L200_train, D10k_val, L10k_val, title='200 Training Samples')
q1.logistic_regression(D2000_train, L2000_train, D10k_val, L10k_val, title='2000 Training Samples')

q1.logistic_regression(D20_train, L20_train, D10k_val, L10k_val, title='20 Training Samples', quadratic=True)
q1.logistic_regression(D200_train, L200_train, D10k_val, L10k_val, title='200 Training Samples', quadratic=True)
q1.logistic_regression(D2000_train, L2000_train, D10k_val, L10k_val, title='2000 Training Samples', quadratic=True)
